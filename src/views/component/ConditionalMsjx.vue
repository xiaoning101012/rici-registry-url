  ...
  <div class="ConditionalSelection">
    <div class="selectaddress">
      <!-- <div class="addresslevel">
        <div class="addresslevel_name">申报状态：</div>
        <div class="level_names level_sx" @click="choosearea">
          <div class="name" :class="{ active: urbanindex == index }" v-for="(item, index) in choosedata.urban"
            :data-index="index" :data-urban="item.id">{{ item.name }}</div>
        </div>
      </div> -->
      ...
      <div v-if="areaindex == 3" class="addresslevel">
      ...
      <div class="addresslevel" v-if="areaindex == 2">
        ...
        <div class="level_names level_sx bordernone">
          <div
            class="name bumen"
            ...
            v-for="(item, index) in togglestatus == 0
              ...
              : choosedata.dept"
            :data-index="index"
            :data-dept="item.departName"
            @click="deptClick(item, index)"
            :key="index"
          >
            <el-tooltip
              :content="item.nameAbb"
              v-if="item.nameAbb.length > 9"
              placement="bottom"
              effect="light"
            >
              <div class="deptName">{{ item.nameAbb }}</div>
            </el-tooltip>
            <div v-else class="deptName">{{ item.nameAbb }}</div>
